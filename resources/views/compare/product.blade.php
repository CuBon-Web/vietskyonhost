         ...
         <div class="col-main page-title rounded p-2 p-md-3 bg-white">
            ...
            <div id="compare-summary" class="w-full grid grid-flow-col grid-cols-2 gap-y-4 gap-x-2 mb-2">
               ...
               <div class="spec-summary will-change-transform">
                  ...
                  <p class="m-0 text-sm sm:text-base"><a target="_blank" href="{{route('detailProduct',['cate'=>$item['cate_slug'],'type'=>$item['type_slug'] ? $item['type_slug'] : 'type','id'=>$item['pro_slug']])}}" title="{{$item['name']}}" class="font-semibold text-rose-600 block w-full leading-6 text-ellipsis overflow-hidden whitespace-nowrap">{{$item['name']}}</a></p>
